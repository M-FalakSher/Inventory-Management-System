...
class billClass:
    def __init__(self,root):
        ...
        self.CartTable.column("stock",width=0,stretch=NO) 
...
#---------------------- all functions ------------------------------
    ...
    def generate_bill(self):
        if self.var_cname.get()=="" or self.var_contact.get()=="":
            ...
            fp=open(rf"C:\Users\HP\Downloads\Compressed\Inventory-Management-System-main\Inventory-Management-System-main\bill\{str(self.invoice)}.txt",'w')
