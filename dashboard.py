...
class IMS:
    def __init__(self,root):
        ...
        self.root.title("Inventory Management System | Falak Sher")
        self.root.resizable(False,False)
        self.root.config(bg="white")

        #------------- title --------------
        self.icon_title=PhotoImage(file=r"C:\Users\HP\Downloads\Compressed\Inventory-Management-System-main\Inventory-Management-System-main\images\logo1.png")
        ...
        #---------------- left menu ---------------
        self.MenuLogo=Image.open(r"C:\Users\HP\Downloads\Compressed\Inventory-Management-System-main\Inventory-Management-System-main\images\menu_im.png")
        ...
        self.icon_side=PhotoImage(file=r"C:\Users\HP\Downloads\Compressed\Inventory-Management-System-main\Inventory-Management-System-main\images\side.png")
        ...
        #------------ footer -----------------
        lbl_footer=Label(self.root,text="IMS-Inventory Management System | Developed by Falak Sher\nFor any Technical Issues Contact: 03164187905",font=("times new roman",12),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)

        self.update_content()
#-------------- functions ----------------

    def logout(self):
        confirm = messagebox.askyesno("Confirm Logout", "Are you sure you want to logout?", parent=self.root)
        if confirm:
            self.root.destroy()
    def employee(self):
    ...
    def update_content(self):
        ...
        try:
            ...
            bill=len(os.listdir(r"C:\Users\HP\Downloads\Compressed\Inventory-Management-System-main\Inventory-Management-System-main\bill"))
